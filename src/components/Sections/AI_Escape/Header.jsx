...
export default function Header() {
  ...
  return (
    <Wrapper>
      ...
      {/* Foreground Content */}
      <ContentWrapper>
        <h1 className="extraBold">AI Space Escape</h1>
        <HeaderP>
...
const Wrapper = styled.div`
  ...
  overflow: hidden;
  background: black; /* Ensures top half stays black */
`;
...
const Overlay = styled.div`
  ...
  width: 100%;
  height: 100%;
  background: rgba(0, 0, 0, 0.5); /* Darker black overlay */
  z-index: 1;
`;
...
const ContentWrapper = styled.div`
  ...
  padding: 20px;
  background: black; /* Keeps the bottom half black */
