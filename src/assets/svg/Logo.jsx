...
function Logo({ darkMode }) {
  return (
    <svg
      ...
      fill={darkMode ? "#FFFFFF" : "#000000"} // White for dark mode, black for light mode
    >
